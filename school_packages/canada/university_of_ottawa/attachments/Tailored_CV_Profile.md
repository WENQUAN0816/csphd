# Tailored CV Profile - University of Ottawa

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Ottawa, his proposed second PhD should be framed as a transition into computer science methods for **Explainable Multimodal AI for Aging-in-Place Indoor Risk Assessment**.
...
My proposed PhD at University of Ottawa would focus on Explainable Multimodal AI for Aging-in-Place Indoor Risk Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Ottawa

## Proposed Title

Explainable Multimodal AI for Aging-in-Place Indoor Risk Assessment
...
## Why It Fits University of Ottawa

Position the project as health-facing multimodal AI and decision support for aging-in-place.
