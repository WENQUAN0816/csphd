# Target Supervisors - York University

## Shortlist

- James Elder - computer vision and visual perception (verify before sending).
- Melanie Baljko - HCI and accessibility-oriented technology (verify before sending).
- Michael Jenkin - robotics, perception, and spatial systems (verify before sending).
