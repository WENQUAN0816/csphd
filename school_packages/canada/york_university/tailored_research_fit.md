# Tailored Research Fit - York University

## School-Specific Framing

For York University, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:

**Accessibility-Aware Computer Vision for Age-Friendly Indoor Spaces**
...
Emphasize accessibility-aware computer vision and explainable spatial decision support for elderly home environments.

## Documents To Tailor

- CV profile paragraph: mention York University and the supervisor's lab theme.
