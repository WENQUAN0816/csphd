# Tailored Research Fit - University of Toronto

## School-Specific Framing

For University of Toronto, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:

**Knowledge-Guided Multimodal Spatial Reasoning for Age-Friendly Indoor Assessment**
...
Frame the proposal as a high-rigor CS project in multimodal spatial reasoning, 3D vision, and explainable assessment for age-friendly indoor environments.

## Documents To Tailor

- CV profile paragraph: mention University of Toronto and the supervisor's lab theme.
