# Target Supervisors - University of Toronto

## Shortlist

- Sanja Fidler - computer vision and visual reasoning (verify before sending).
- Alec Jacobson - geometry processing and 3D computation (verify before sending).
- Karan Singh - graphics, HCI, and design computation (verify before sending).
- Steven Waslander - robotics and spatial perception (verify before sending).
