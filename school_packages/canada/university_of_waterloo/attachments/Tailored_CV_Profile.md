# Tailored CV Profile - University of Waterloo

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Waterloo, his proposed second PhD should be framed as a transition into computer science methods for **Human-AI Spatial Intelligence for Age-Friendly Indoor Environment Assessment**.
...
My proposed PhD at University of Waterloo would focus on Human-AI Spatial Intelligence for Age-Friendly Indoor Environment Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Waterloo

## Proposed Title

Human-AI Spatial Intelligence for Age-Friendly Indoor Environment Assessment
...
## Why It Fits University of Waterloo

Position the work as human-AI spatial assessment for aging-in-place, with expert-in-the-loop validation and explainable recommendations.
