# Target Supervisors - University of Waterloo

## Shortlist

- Cosmin Munteanu - HCI, accessibility, aging, speech and interactive systems (verify before sending).
- Edith Law - human-AI collaboration, crowdsourcing, augmented intelligence (verify before sending).
- Jesse Hoey - AI for health, cognitive assistance, decision-making under uncertainty (verify before sending).
- Mark Hancock - HCI and interactive systems (verify before sending).
