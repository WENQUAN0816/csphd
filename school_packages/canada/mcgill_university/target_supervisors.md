# Target Supervisors - McGill University

## Shortlist

- Karyn Moffatt - accessibility, HCI, and aging-related technology (verify before sending).
- Derek Ruths - social computing and applied AI (verify before sending).
- Joelle Pineau - AI, reinforcement learning, and health applications (verify before sending).
