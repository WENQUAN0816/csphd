# Target Supervisors - Carleton University

## Shortlist

- Audrey Girouard - HCI and interactive systems (verify before sending).
- Anthony Whitehead - interactive systems and applied computing (verify before sending).
- Ali Arya - HCI, serious games, and interactive technology (verify before sending).
