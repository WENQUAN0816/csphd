# Tailored CV Profile - Carleton University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Carleton University, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered AI for Age-Friendly Indoor Accessibility Assessment**.
...
My proposed PhD at Carleton University would focus on Human-Centered AI for Age-Friendly Indoor Accessibility Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Carleton University

## Proposed Title

Human-Centered AI for Age-Friendly Indoor Accessibility Assessment
...
## Why It Fits Carleton University

Frame the project as an HCI and assistive technology system for expert-guided indoor accessibility assessment.
