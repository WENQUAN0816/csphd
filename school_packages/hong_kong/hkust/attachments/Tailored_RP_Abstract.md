# Tailored Research Proposal Abstract - The Hong Kong University of Science and Technology

## Working Title

Knowledge-Guided VLM and 3D Spatial Reasoning for Age-Friendly Indoor Assessment
...
At The Hong Kong University of Science and Technology, the proposal should be tailored toward the supervisor's strengths in [insert verified lab strength]. The expected contribution is a lightweight, explainable, and human-centered AI workflow that connects computer science methods with a high-impact aging-in-place application.
