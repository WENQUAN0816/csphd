# Tailored Research Proposal Abstract - City University of Hong Kong

## Working Title

Applied AI and Image-Based Spatial Risk Assessment for Age-Friendly Homes
...
At City University of Hong Kong, the proposal should be tailored toward the supervisor's strengths in [insert verified lab strength]. The expected contribution is a lightweight, explainable, and human-centered AI workflow that connects computer science methods with a high-impact aging-in-place application.
