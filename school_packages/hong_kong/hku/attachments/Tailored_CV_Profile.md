# Tailored CV Profile - The University of Hong Kong

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For The University of Hong Kong, his proposed second PhD should be framed as a transition into computer science methods for **Explainable Multimodal AI for Age-Friendly Indoor Spatial Assessment**.
...
My proposed PhD at The University of Hong Kong would focus on Explainable Multimodal AI for Age-Friendly Indoor Spatial Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - The University of Hong Kong

## Proposed Title

Explainable Multimodal AI for Age-Friendly Indoor Spatial Assessment
...
## Why It Fits The University of Hong Kong

Frame the project around data-driven and explainable spatial assessment with VLM support.
