# Target Supervisors - The University of Hong Kong

## Shortlist

- Wenping Wang - computer graphics and geometry (verify before sending).
- Reynold Cheng - data systems and urban/AI data applications (verify before sending).
- Chiew-Lan Tai - graphics and geometric computing (verify before sending).
