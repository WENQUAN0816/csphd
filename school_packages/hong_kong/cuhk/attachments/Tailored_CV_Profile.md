# Tailored CV Profile - The Chinese University of Hong Kong

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For The Chinese University of Hong Kong, his proposed second PhD should be framed as a transition into computer science methods for **Computer Vision and Vision-Language Models for Age-Friendly Indoor Environments**.
...
My proposed PhD at The Chinese University of Hong Kong would focus on Computer Vision and Vision-Language Models for Age-Friendly Indoor Environments, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - The Chinese University of Hong Kong

## Proposed Title

Computer Vision and Vision-Language Models for Age-Friendly Indoor Environments
...
## Why It Fits The Chinese University of Hong Kong

Position the proposal as CV/VLM plus health-aging indoor assessment.
