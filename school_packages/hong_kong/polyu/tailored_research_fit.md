# Tailored Research Fit - The Hong Kong Polytechnic University

## School-Specific Framing

For The Hong Kong Polytechnic University, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:

**AI-Assisted Spatial Intelligence for Age-Friendly Indoor Design Recommendation**
...
Frame as a strong cross-disciplinary AI + built environment PhD with practical deployment value.

## Documents To Tailor

- CV profile paragraph: mention The Hong Kong Polytechnic University and the supervisor's lab theme.
