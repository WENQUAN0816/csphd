# Tailored CV Profile - University of Edinburgh

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Edinburgh, his proposed second PhD should be framed as a transition into computer science methods for **Explainable Spatial Reasoning for Age-Friendly Indoor AI**.
...
My proposed PhD at University of Edinburgh would focus on Explainable Spatial Reasoning for Age-Friendly Indoor AI, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Edinburgh

## Proposed Title

Explainable Spatial Reasoning for Age-Friendly Indoor AI
...
## Why It Fits University of Edinburgh

Position as AI/spatial reasoning with explainable decision-support for healthy aging.
