# Tailored CV Profile - University of Bristol

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Bristol, his proposed second PhD should be framed as a transition into computer science methods for **Visual-Spatial Sensing for Age-Friendly Indoor Assessment**.
...
My proposed PhD at University of Bristol would focus on Visual-Spatial Sensing for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Bristol

## Proposed Title

Visual-Spatial Sensing for Age-Friendly Indoor Assessment
...
## Why It Fits University of Bristol

Emphasize visual/spatial sensing and interactive assessment for older adults' homes.
