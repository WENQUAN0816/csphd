# Target Supervisors - University of Bristol

## Shortlist

- Walterio Mayol-Cuevas - computer vision and robotics (verify before sending).
- Mike Fraser - HCI and interaction (verify before sending).
- Dima Damen - computer vision and egocentric vision connection to verify before sending.
