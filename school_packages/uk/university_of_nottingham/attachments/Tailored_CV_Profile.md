# Tailored CV Profile - University of Nottingham

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Nottingham, his proposed second PhD should be framed as a transition into computer science methods for **Mixed-Reality and Human-AI Tools for Age-Friendly Indoor Assessment**.
...
My proposed PhD at University of Nottingham would focus on Mixed-Reality and Human-AI Tools for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Nottingham

## Proposed Title

Mixed-Reality and Human-AI Tools for Age-Friendly Indoor Assessment
...
## Why It Fits University of Nottingham

Frame as mixed-reality and HCI-supported age-friendly spatial assessment.
