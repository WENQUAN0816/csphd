# Tailored CV Profile - University College London

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University College London, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered Vision-Language Systems for Age-Friendly Indoor Assessment**.
...
My proposed PhD at University College London would focus on Human-Centered Vision-Language Systems for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University College London

## Proposed Title

Human-Centered Vision-Language Systems for Age-Friendly Indoor Assessment
...
## Why It Fits University College London

Frame as HCI/VLM/VR-ready spatial assessment for aging-in-place.
