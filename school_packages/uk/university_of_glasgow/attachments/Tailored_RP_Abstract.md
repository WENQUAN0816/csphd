# Tailored Research Proposal Abstract - University of Glasgow

## Working Title

Accessibility-Focused HCI and AI for Age-Friendly Indoor Spaces
...
At University of Glasgow, the proposal should be tailored toward the supervisor's strengths in [insert verified lab strength]. The expected contribution is a lightweight, explainable, and human-centered AI workflow that connects computer science methods with a high-impact aging-in-place application.
