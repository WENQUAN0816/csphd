# Target Supervisors - University of Glasgow

## Shortlist

- Stephen Brewster - multimodal HCI (verify before sending).
- Mohamed Khamis - HCI and interaction (verify before sending).
- Alessandro Vinciarelli - social signal processing and AI (verify before sending).
