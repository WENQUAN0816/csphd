# Tailored CV Profile - Northeastern University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Northeastern University, his proposed second PhD should be framed as a transition into computer science methods for **Health-Facing HCI and AI for Age-Friendly Indoor Environments**.
...
My proposed PhD at Northeastern University would focus on Health-Facing HCI and AI for Age-Friendly Indoor Environments, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Northeastern University

## Proposed Title

Health-Facing HCI and AI for Age-Friendly Indoor Environments
...
## Why It Fits Northeastern University

Frame around health-facing HCI and spatial decision support for older adults.
