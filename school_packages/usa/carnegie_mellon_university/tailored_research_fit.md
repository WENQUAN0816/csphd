# Tailored Research Fit - Carnegie Mellon University

## School-Specific Framing

For Carnegie Mellon University, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:
...
Frame as HCI + VLM + spatial computing for assistive indoor design assessment.

## Documents To Tailor

- CV profile paragraph: mention Carnegie Mellon University and the supervisor's lab theme.
