# Target Supervisors - Arizona State University

## Shortlist

- Subbarao Kambhampati - AI and planning (verify before sending).
- Baoxin Li - computer vision (verify before sending).
- Heni Ben Amor - robotics and human-robot interaction (verify before sending).
