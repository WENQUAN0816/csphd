# Tailored CV Profile - Arizona State University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Arizona State University, his proposed second PhD should be framed as a transition into computer science methods for **Applied AI Prototypes for Age-Friendly Indoor Spatial Assessment**.
...
My proposed PhD at Arizona State University would focus on Applied AI Prototypes for Age-Friendly Indoor Spatial Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Arizona State University

## Proposed Title

Applied AI Prototypes for Age-Friendly Indoor Spatial Assessment
...
## Why It Fits Arizona State University

Emphasize applied AI prototype development and deployable indoor assessment.
