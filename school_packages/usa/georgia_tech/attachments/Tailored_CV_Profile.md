# Tailored CV Profile - Georgia Institute of Technology

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Georgia Institute of Technology, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered AI for Age-Friendly Indoor Decision Support**.
...
My proposed PhD at Georgia Institute of Technology would focus on Human-Centered AI for Age-Friendly Indoor Decision Support, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Georgia Institute of Technology

## Proposed Title

Human-Centered AI for Age-Friendly Indoor Decision Support
...
## Why It Fits Georgia Institute of Technology

Emphasize human-centered computing and AI decision support for older adults' indoor environments.
