# Tailored CV Profile - University of Illinois Urbana-Champaign

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Illinois Urbana-Champaign, his proposed second PhD should be framed as a transition into computer science methods for **Explainable Computer Vision for Indoor Fall-Risk and Accessibility Assessment**.
...
My proposed PhD at University of Illinois Urbana-Champaign would focus on Explainable Computer Vision for Indoor Fall-Risk and Accessibility Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Illinois Urbana-Champaign

## Proposed Title

Explainable Computer Vision for Indoor Fall-Risk and Accessibility Assessment
...
## Why It Fits University of Illinois Urbana-Champaign

Position as robust computer vision and explainable spatial assessment for indoor safety.
