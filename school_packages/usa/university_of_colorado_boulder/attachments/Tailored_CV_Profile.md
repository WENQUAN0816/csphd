# Tailored CV Profile - University of Colorado Boulder

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Colorado Boulder, his proposed second PhD should be framed as a transition into computer science methods for **Accessibility-First HCI and Spatial AI for Older Adults' Home Safety**.
...
My proposed PhD at University of Colorado Boulder would focus on Accessibility-First HCI and Spatial AI for Older Adults' Home Safety, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Colorado Boulder

## Proposed Title

Accessibility-First HCI and Spatial AI for Older Adults' Home Safety
...
## Why It Fits University of Colorado Boulder

Frame as accessibility-first HCI and computer vision for older adults' home safety.
