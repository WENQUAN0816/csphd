# Tailored CV Profile - University of Washington

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Washington, his proposed second PhD should be framed as a transition into computer science methods for **Accessibility-Aware Human-AI Spatial Assessment for Aging-in-Place**.
...
My proposed PhD at University of Washington would focus on Accessibility-Aware Human-AI Spatial Assessment for Aging-in-Place, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Washington

## Proposed Title

Accessibility-Aware Human-AI Spatial Assessment for Aging-in-Place
...
## Why It Fits University of Washington

Pitch accessibility-aware human-AI spatial assessment for aging-in-place.
