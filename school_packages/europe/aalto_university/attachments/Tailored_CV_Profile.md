# Tailored CV Profile - Aalto University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Aalto University, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered AI and Computational Design for Age-Friendly Indoor Environments**.
...
My proposed PhD at Aalto University would focus on Human-Centered AI and Computational Design for Age-Friendly Indoor Environments, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Aalto University

## Proposed Title

Human-Centered AI and Computational Design for Age-Friendly Indoor Environments
...
## Why It Fits Aalto University

Frame as human-centered AI and computational design for accessible indoor environments.
