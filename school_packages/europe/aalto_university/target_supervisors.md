# Target Supervisors - Aalto University

## Shortlist

- Antti Oulasvirta - HCI and computational interaction (verify before sending).
- Samuel Kaski - machine learning and AI (verify before sending).
- Aalto HCI/design computation supervisors - verify before sending.
