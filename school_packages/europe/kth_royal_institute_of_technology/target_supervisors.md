# Target Supervisors - KTH Royal Institute of Technology

## Shortlist

- Danica Kragic - robotics and computer vision (verify before sending).
- Mario Romero - HCI and visualization (verify before sending).
- KTH HCI/visualization/robotics faculty - verify before sending.
