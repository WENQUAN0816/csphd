# Tailored CV Profile - KTH Royal Institute of Technology

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For KTH Royal Institute of Technology, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered Spatial AI for Safe Aging-in-Place Environments**.
...
My proposed PhD at KTH Royal Institute of Technology would focus on Human-Centered Spatial AI for Safe Aging-in-Place Environments, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - KTH Royal Institute of Technology

## Proposed Title

Human-Centered Spatial AI for Safe Aging-in-Place Environments
...
## Why It Fits KTH Royal Institute of Technology

Frame as spatial AI and human-centered technology for safe aging-in-place.
