# Tailored CV Profile - Saarland University / DFKI

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Saarland University / DFKI, his proposed second PhD should be framed as a transition into computer science methods for **Knowledge-Guided AI for Interactive Indoor Spatial Assessment**.
...
My proposed PhD at Saarland University / DFKI would focus on Knowledge-Guided AI for Interactive Indoor Spatial Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Saarland University / DFKI

## Proposed Title

Knowledge-Guided AI for Interactive Indoor Spatial Assessment
...
## Why It Fits Saarland University / DFKI

Pitch knowledge-guided AI and interactive spatial decision support.
