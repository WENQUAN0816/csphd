# Tailored CV Profile - Technical University of Munich

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Technical University of Munich, his proposed second PhD should be framed as a transition into computer science methods for **3D Vision and Spatial Intelligence for Age-Friendly Indoor Assessment**.
...
My proposed PhD at Technical University of Munich would focus on 3D Vision and Spatial Intelligence for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Technical University of Munich

## Proposed Title

3D Vision and Spatial Intelligence for Age-Friendly Indoor Assessment
...
## Why It Fits Technical University of Munich

Emphasize 3D vision and spatial intelligence for indoor assessment.
