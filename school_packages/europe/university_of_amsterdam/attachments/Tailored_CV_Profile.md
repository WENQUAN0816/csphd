# Tailored CV Profile - University of Amsterdam

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Amsterdam, his proposed second PhD should be framed as a transition into computer science methods for **Vision-Language Scene Understanding for Age-Friendly Indoor Assessment**.
...
My proposed PhD at University of Amsterdam would focus on Vision-Language Scene Understanding for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Amsterdam

## Proposed Title

Vision-Language Scene Understanding for Age-Friendly Indoor Assessment
...
## Why It Fits University of Amsterdam

Frame as VLM, multimedia understanding, and explainable indoor scene assessment.
