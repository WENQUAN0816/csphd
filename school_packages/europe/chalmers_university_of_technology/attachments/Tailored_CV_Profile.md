# Tailored CV Profile - Chalmers University of Technology

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Chalmers University of Technology, his proposed second PhD should be framed as a transition into computer science methods for **Interaction-Centered AI for Age-Friendly Indoor Assessment**.
...
My proposed PhD at Chalmers University of Technology would focus on Interaction-Centered AI for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Chalmers University of Technology

## Proposed Title

Interaction-Centered AI for Age-Friendly Indoor Assessment
...
## Why It Fits Chalmers University of Technology

Pitch an interaction-design and AI assessment system for age-friendly homes.
