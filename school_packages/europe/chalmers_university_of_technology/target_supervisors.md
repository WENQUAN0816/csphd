# Target Supervisors - Chalmers University of Technology

## Shortlist

- Morten Fjeld - HCI and interaction design (verify before sending).
- Fredrik Kahl - computer vision connection to verify before sending.
- AI/interaction design doctoral openings - verify before sending.
