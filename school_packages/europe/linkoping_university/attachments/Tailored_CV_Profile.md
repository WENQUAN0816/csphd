# Tailored CV Profile - Linkoping University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Linkoping University, his proposed second PhD should be framed as a transition into computer science methods for **Visual Analytics and Spatial AI for Age-Friendly Indoor Risk Assessment**.
...
My proposed PhD at Linkoping University would focus on Visual Analytics and Spatial AI for Age-Friendly Indoor Risk Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Linkoping University

## Proposed Title

Visual Analytics and Spatial AI for Age-Friendly Indoor Risk Assessment
...
## Why It Fits Linkoping University

Emphasize visualization, point-cloud reasoning, and explainable spatial assessment.
