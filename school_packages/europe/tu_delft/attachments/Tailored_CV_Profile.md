# Tailored CV Profile - TU Delft

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For TU Delft, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered AI for Knowledge-Guided Indoor Spatial Assessment**.
...
My proposed PhD at TU Delft would focus on Human-Centered AI for Knowledge-Guided Indoor Spatial Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - TU Delft

## Proposed Title

Human-Centered AI for Knowledge-Guided Indoor Spatial Assessment
...
## Why It Fits TU Delft

Position as human-centered AI and design knowledge for spatial assessment.
