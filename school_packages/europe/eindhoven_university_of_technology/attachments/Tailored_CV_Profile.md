# Tailored CV Profile - Eindhoven University of Technology

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Eindhoven University of Technology, his proposed second PhD should be framed as a transition into computer science methods for **Smart-Home Human-AI Interaction for Age-Friendly Indoor Assessment**.
...
My proposed PhD at Eindhoven University of Technology would focus on Smart-Home Human-AI Interaction for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Eindhoven University of Technology

## Proposed Title

Smart-Home Human-AI Interaction for Age-Friendly Indoor Assessment
...
## Why It Fits Eindhoven University of Technology

Frame as smart-home HCI and explainable AI for older adults' indoor environments.
