# Tailored CV Profile - University of Sydney

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Sydney, his proposed second PhD should be framed as a transition into computer science methods for **Interactive AI for Age-Friendly Indoor Safety and Accessibility Assessment**.
...
My proposed PhD at University of Sydney would focus on Interactive AI for Age-Friendly Indoor Safety and Accessibility Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Sydney

## Proposed Title

Interactive AI for Age-Friendly Indoor Safety and Accessibility Assessment
...
## Why It Fits University of Sydney

Emphasize interactive, evidence-based AI support for indoor safety and accessibility.
