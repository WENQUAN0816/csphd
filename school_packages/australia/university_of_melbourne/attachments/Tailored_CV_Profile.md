# Tailored CV Profile - University of Melbourne

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Melbourne, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered Multimodal AI for Age-Friendly Indoor Decision Support**.
...
My proposed PhD at University of Melbourne would focus on Human-Centered Multimodal AI for Age-Friendly Indoor Decision Support, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Melbourne

## Proposed Title

Human-Centered Multimodal AI for Age-Friendly Indoor Decision Support
...
## Why It Fits University of Melbourne

Emphasize high-quality HCI/AI evaluation and deployable decision support for indoor environments.
