# Tailored CV Profile - RMIT University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For RMIT University, his proposed second PhD should be framed as a transition into computer science methods for **Applied Spatial Intelligence for Age-Friendly Built Environment Assessment**.
...
My proposed PhD at RMIT University would focus on Applied Spatial Intelligence for Age-Friendly Built Environment Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - RMIT University

## Proposed Title

Applied Spatial Intelligence for Age-Friendly Built Environment Assessment
...
## Why It Fits RMIT University

Frame as applied spatial intelligence and decision-support software for age-friendly environments.
