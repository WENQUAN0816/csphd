# Target Supervisors - Monash University

## Shortlist

- Michael Wybrow - HCI, visualization, and interactive systems (verify before sending).
- Geoff Webb - machine learning and data mining (verify before sending).
- Tom Drummond - computer vision connection to verify before sending.
- Human-Centred Computing group supervisors - verify before sending.
