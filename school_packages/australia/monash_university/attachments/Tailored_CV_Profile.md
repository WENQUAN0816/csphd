# Tailored CV Profile - Monash University

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Monash University, his proposed second PhD should be framed as a transition into computer science methods for **Knowledge-Guided Vision-Language Models for Age-Friendly Indoor Assessment**.
...
My proposed PhD at Monash University would focus on Knowledge-Guided Vision-Language Models for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Monash University

## Proposed Title

Knowledge-Guided Vision-Language Models for Age-Friendly Indoor Assessment
...
## Why It Fits Monash University

Frame the project as VLM/spatial AI for aging-in-place with explainability and prototype validation.
