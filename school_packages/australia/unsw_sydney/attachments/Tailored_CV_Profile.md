# Tailored CV Profile - UNSW Sydney

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For UNSW Sydney, his proposed second PhD should be framed as a transition into computer science methods for **Explainable Computer Vision for Age-Friendly Indoor Safety Assessment**.
...
My proposed PhD at UNSW Sydney would focus on Explainable Computer Vision for Age-Friendly Indoor Safety Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - UNSW Sydney

## Proposed Title

Explainable Computer Vision for Age-Friendly Indoor Safety Assessment
...
## Why It Fits UNSW Sydney

Frame as applied AI and computer vision for safe and accessible indoor environments.
