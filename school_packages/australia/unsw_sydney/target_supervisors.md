# Target Supervisors - UNSW Sydney

## Shortlist

- Toby Walsh - AI and responsible AI (verify before sending).
- Flora Salim - spatio-temporal data and AI connection to verify before sending.
- Computer vision / human-centered AI supervisors - verify before sending.
