# Tailored Research Proposal Abstract - University of Nottingham Malaysia

## Working Title

Neural Computation and Spatial AI for Age-Friendly Indoor Decision Support
...
At University of Nottingham Malaysia, the proposal should be tailored toward the selected supervisor's strengths. The expected contribution is a lightweight, explainable, and human-centered AI workflow that connects computer science methods with a high-impact aging-in-place application.
