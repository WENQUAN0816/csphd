# Tailored Research Proposal Abstract - Monash University Malaysia

## Working Title

Human-Centred Computer Vision for Age-Friendly Indoor Assessment
...
At Monash University Malaysia, the proposal should be tailored toward the selected supervisor's strengths. The expected contribution is a lightweight, explainable, and human-centered AI workflow that connects computer science methods with a high-impact aging-in-place application.
