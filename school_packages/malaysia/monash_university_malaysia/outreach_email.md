# Outreach Email - Monash University Malaysia

Subject: Prospective PhD applicant: Human-Centred Computer Vision for Age-Friendly Indoor Assessment

Dear Professor Dharmaratne,
...
I am now seeking a second PhD in Computer Science / AI / HCI to move from domain-specific built environment research toward computational methods. For Monash University Malaysia, I am particularly interested in a project on "Human-Centred Computer Vision for Age-Friendly Indoor Assessment".
...
I see a possible fit with your work on image processing, computer vision, digital health, and human-centred computing because my proposed research connects indoor spatial assessment with explainable visual evidence and expert-in-the-loop design recommendations.
...
- Recipient: Anuja Dharmaratne <Anuja.Dharmaratne@monash.edu>
- Check the salutation and supervisor title one more time.
- Attach only the school-specific files from ttachments/ after PDF generation.
