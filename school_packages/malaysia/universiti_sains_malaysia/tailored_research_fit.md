# Tailored Research Fit - Universiti Sains Malaysia

## School-Specific Framing

For Universiti Sains Malaysia, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:

**Explainable Computer Vision for Age-Friendly Indoor Risk and Accessibility Assessment**
...
Frame the second PhD as a cross-school CS method-development continuation from the completed design PhD, avoiding the impression of repeating the first PhD.
