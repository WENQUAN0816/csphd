# Tailored CV Profile - Victoria University of Wellington

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For Victoria University of Wellington, his proposed second PhD should be framed as a transition into computer science methods for **Explainable AI and Software Prototyping for Age-Friendly Indoor Assessment**.
...
My proposed PhD at Victoria University of Wellington would focus on Explainable AI and Software Prototyping for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - Victoria University of Wellington

## Proposed Title

Explainable AI and Software Prototyping for Age-Friendly Indoor Assessment
...
## Why It Fits Victoria University of Wellington

Use the proposal as an applied AI and software prototype for explainable age-friendly assessment.
