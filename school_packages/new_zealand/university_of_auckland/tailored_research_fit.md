# Tailored Research Fit - University of Auckland

## School-Specific Framing

For University of Auckland, frame Wen Quan's second PhD as a computer science transition from age-friendly built environment research into:

**Vision-Language and HCI Frameworks for Age-Friendly Indoor Spatial Assessment**
...
Frame the project as AR/HCI-ready spatial intelligence for age-friendly indoor assessment and design recommendation.

## Documents To Tailor

- CV profile paragraph: mention University of Auckland and the supervisor's lab theme.
