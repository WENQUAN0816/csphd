# Tailored CV Profile - University of Canterbury

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Canterbury, his proposed second PhD should be framed as a transition into computer science methods for **Interactive Spatial AI for Age-Friendly Indoor Assessment**.
...
My proposed PhD at University of Canterbury would focus on Interactive Spatial AI for Age-Friendly Indoor Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Canterbury

## Proposed Title

Interactive Spatial AI for Age-Friendly Indoor Assessment
...
## Why It Fits University of Canterbury

Emphasize an interactive assessment system for expert validation of indoor spatial risks.
