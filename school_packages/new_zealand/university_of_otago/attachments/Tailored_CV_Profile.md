# Tailored CV Profile - University of Otago

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Otago, his proposed second PhD should be framed as a transition into computer science methods for **Human-Centered AI for Healthy Aging Indoor Environment Assessment**.
...
My proposed PhD at University of Otago would focus on Human-Centered AI for Healthy Aging Indoor Environment Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Otago

## Proposed Title

Human-Centered AI for Healthy Aging Indoor Environment Assessment
...
## Why It Fits University of Otago

Emphasize health-aging assessment and expert validation rather than pure algorithm novelty.
