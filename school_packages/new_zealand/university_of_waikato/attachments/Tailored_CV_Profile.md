# Tailored CV Profile - University of Waikato

Wen Quan is an AI-assisted built environment researcher with a completed PhD in Interior Design from Universiti Sains Malaysia. For University of Waikato, his proposed second PhD should be framed as a transition into computer science methods for **Lightweight Machine Learning for Age-Friendly Indoor Risk Assessment**.
...
My proposed PhD at University of Waikato would focus on Lightweight Machine Learning for Age-Friendly Indoor Risk Assessment, connecting my age-friendly built environment foundation with the school's strengths in [insert verified lab strength].
"@

     = @"
# Tailored Research Concept Note - University of Waikato

## Proposed Title

Lightweight Machine Learning for Age-Friendly Indoor Risk Assessment
...
## Why It Fits University of Waikato

Pitch lightweight ML, meta-learning, and explainable assessment rather than large-scale VLM training.
